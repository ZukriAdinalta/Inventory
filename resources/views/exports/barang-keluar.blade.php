  ...
  <table style="margin-left: auto; margin-right: auto;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="border: 1px solid #000000; text-align: center;">{{ $BK->Inven->k_inven }}</td>
        <td style="border: 1px solid #000000; text-align: center;">{{ $BK->jenbar }}</td>
        <td style="border: 1px solid #000000; text-align: center;">{{ $BK->nambar }}</td>
        <td style="border: 1px solid #000000; text-align: center;">{{ $BK->jumlah_keluar }}</td>
        <td style="border: 1px solid #000000; text-align: center;">{{ $BK->Inven->jumlah }}</td>
        <td style="border: 1px solid #000000; text-align: center;">{{ tgl_indo(date( $BK->tgl_keluar)) }}</td>
        <td style="border: 1px solid #000000; text-align: center;">{{ $BK->User->nama }}</td>
      </tr>
      @endforeach
      <tr>
