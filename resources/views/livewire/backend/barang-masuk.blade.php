                        ...
                        <div class="card-body">
                            <form>
                                <div class="row justify-content-strat mt-1">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" wire:model='tgl_masuk'
                                                class="form-control @error('tgl_masuk') is-invalid @enderror" id="kode">
                                            @error('tgl_masuk')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="nambar">Barang Masuk <span class="text-danger">*</span></label>
                                ...
                                <div class="modal-footer mb-0">
                                    @if ($this->update == true)
                                    <button wire:click.prevent='Update({{ $this->id_masuk }})'
            ...
            <table class="table table-hover table-striped ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $BM->User->nama }}</td>
                        <td><a wire:click="Edit({{ $BM->id }}) " type="button" data-toggle="modal"
                                data-target="#create"><i class="fas fa-pen text-primary"></i></a>
                            |
                            <a wire:click="DeleteData({{ $BM->id }}) " type="button"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content text-white bg-danger border-primary">
                ...
                <div class="modal-body justify-content-center">
                    ...
                    <p class="col-form-label">Yakin Hapus Barang Masuk:</p>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"
                        wire:click.prevent="Delete({{ $this->id_masuk }})">Delete</button>
                </div>
            </div>
        </div>
    </div>
